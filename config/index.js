export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx64b43f54de93f995",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "fd83d85b4e535048f0b628fe43f4485c",
  ...
  USERS: [
    {
      ...
      id: "opqwy5wCdsb7PQxt0N4a8QISxmos",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "GmsBduRuq3XP2ixcQ1vs8X9B7oHTn_EnqQcwvgg8XZ4",
      // 所在省份
      province: "山西",
      // 所在城市
      city: "太原",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2004", "date": "09-09"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "二奎宝宝", "year": "2004", "date": "07-20"},
  ...
  CALLBACK_TEMPLATE_ID: "GmsBduRuq3XP2ixcQ1vs8X9B7oHTn_EnqQcwvgg8XZ4",
